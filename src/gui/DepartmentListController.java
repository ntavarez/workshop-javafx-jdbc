...
public class DepartmentListController implements Initializable, DataChangeListener { //classe que recebe o evento listener (observer)
	...
	private void createDialogForm(Department obj, String absoluteName, Stage parentStage) { // instanciando janela de diálogo
		try {
