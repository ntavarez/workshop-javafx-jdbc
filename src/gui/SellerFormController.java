...
public class SellerFormController implements Initializable { // classe que emite o evento listener (subject)
	...
	private Seller getFormData() { // pegando dados do formulário e colocando no obj Seller
		...
		if (dpBirthDate.getValue() == null) {
			...
			Instant instant = Instant.from(dpBirthDate.getValue().atStartOfDay(ZoneId.systemDefault())); // pegando
																											// valor do
																											// date
																											// picker
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		labelErrorName.setText((fields.contains("name")) ? errors.get("name") : ""); //operador ternário: se o campo contém nome for verdadeiro, retornar o erro, caso não, retornar campo vazio
